...
#sempre que precisar installar varias bibliotecas, criar lista em bloco de notas com o titulo do arquivo de requirements.txt; daí no terminal pip install -r requirements.txt e vai instalar tudo
